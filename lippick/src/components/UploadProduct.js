    ...
    <div className="upload-wrap">
      ...
      <Form className="upload-form" onSubmitCapture={submitHandler}>
        ...
        <div className="upload-bottom" >
          ...
          <select className="upload-select" onChange={categoryChangeHandler} value={Category}>
          ...
          <select  className="upload-select" onChange={toneChangeHandler} value={Tone}>
          ...
          <Button className="upload-btn" htmlType="submit">확인</Button>
        </div>
      </Form>
    </div>
  );
