      ...
      >
        ...
        <div className="product-content-wrap">
          <Link
            ...
            style={{ linkStyle, textDecoration: "none" }}
          >
            <span className="product-title" style={{ color: "#333" }}>
              {product.title}
            </span>
          </Link>
          ...
          <span className="product-price" style={{ marginTop: "1vh" }}>
            {product.price} 원
          </span>
        </div>
      </Col>
          ...
          <div className="bg-wrap">
            ...
            <div className="content-text">
              ...
              <span style={{ fontSize: "0.8rem" }}>
                빠르고 쉽게 바를 수 있는 샤넬 립밤. 편안한 텍스처로 입술을
                부드럽게 감싸는 모이스처라이징 립 케어 제품입니다. 입술에 건강한
                윤기를 더하는 루쥬 코코 밤. 수분감을 채워 건강해진 입술을 경험할
                수 있습니다. 자연스러운 컬러로 입술에 촉촉한 수분을 공급해주는
                레 베쥬 립밤은 섬세한 컬러를 머금은 매끄러운 입술을 선사합니다.
              </span>
            </div>
          </div>
