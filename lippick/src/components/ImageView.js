    ...
    <div className="colortest-wrap">
      ...
      <div className="colortest-right-wrap">
        ...
        <div className="colortest-right-wrap-span">
          <span>립픽 머신러닝 학습 모델을 통해 퍼스널 컬러를 진단합니다.</span>
        </div>
        <div
          style={{
            alignItems: "center",
                ...
                {props.Products.slice(0, 2).map((product) => {
                  return (
                    <div
                      ...
                      onClick={() => drawMesh(face, ctx, product.color)}
                    >
                      <img
        ...
        <div className="btn-wrap">
          ...
          <div className="input-image-wrap">
            <label className="input-image-btn" onClick={() => predict()}>
              <div className="icon-wrap">
                <AiOutlineSmile />
              </div>
              <span>테스트</span>
        ...
        <div >
              <span className="test-span">*립스틱 사진을 클릭하면 테스트해볼 수 있습니다.</span>
          </div>
      </div>
    </div>
  );
